...
//Importing package
//Class 1
//HelperExx class implementing Runnable interface
class HelperExx implements Runnable {
...
//Class 2
//HelperExx class extending Runnable interface
public class ThreadMethods implements Runnable {
	...
	public static void main(String[] args) {
		...
		Thread thread3 = new Thread(new HelperExx());
